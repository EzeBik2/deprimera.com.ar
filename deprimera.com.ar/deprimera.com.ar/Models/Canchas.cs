...
namespace deprimera.com.ar.Models
{
    public class Canchas
    {
        ...
        public static bool AfiliarCancha(Cancha unaCancha)
        {
            try
            {
                ...
                nombre.Value = unaCancha.Nombre;
                OleDbParameter barrio = new OleDbParameter("barrio", OleDbType.VarChar, 88);
                barrio.Value = unaCancha.Barrio;
                OleDbParameter calle1 = new OleDbParameter("calle1", OleDbType.VarChar, 88);
                calle1.Value = unaCancha.Calle1;
                OleDbParameter calle2 = new OleDbParameter("calle2", OleDbType.VarChar, 88);
                calle2.Value = unaCancha.Calle2;
                OleDbParameter telefono = new OleDbParameter("telefono", OleDbType.VarChar, 88);
                telefono.Value = unaCancha.Telefono;

                Consulta.Parameters.Add(nombre);
                Consulta.Parameters.Add(barrio);
                Consulta.Parameters.Add(calle1);
                Consulta.Parameters.Add(calle2);
